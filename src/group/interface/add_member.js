...
import successAddMemberPrompt from "../prompt/success_add_member.js";

const addMember = async (language) => {
  let groupName = "";
  ...
  await groupCommand.addMember({ groupName, userName });
  console.log(successAddMemberPrompt[language](groupName, userName));
};
